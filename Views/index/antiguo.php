...
<div class="container-fluid mt-5 ">
    ...
    <div class="texto-huracan1">
        <img src="<?php echo IMG_PATH; ?>car6.gif" alt="Carro ferrari" width="1250" height="600">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm">
                <img src="<?php echo IMG_PATH; ?>car9.png" alt="Carro ferrari (2)" width="700" height="400">
            </div>
            <div class="col-sm">
    ...
    <div class="texto-huracan1">
        <img src="<?php echo IMG_PATH; ?>car9.gif" alt="Carro VOLKSWAGEN" width="1250" height="600">
        <div class="texto-huracan2">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm">
                <img src="<?php echo IMG_PATH; ?>car12.png" alt="Carro VOLKSWAGEN (2)" width="800" height="500">
            </div>
            <div class="col-sm">
